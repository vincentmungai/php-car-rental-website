				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">Bookings Info</div><button onclick="window.print()">Print report</button>
...
if($result->Status==0)
{
echo htmlentities('Pending Confirmation');
} else if ($result->Status==1)
{
echo htmlentities('Confirmed, awaiting pick up ');
}
 else{
			...
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="panel panel-default">
							<div class="panel-heading">Vehicle listing</div>
							<div class="panel-body">
							<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
				else if($msg){?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
								<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
