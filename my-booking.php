...
<li>
            ...
            <div class="clearfix"></div>
                ...
                { ?>
                <div class="vehicle_status"> <a href="#" class="btn outline btn-xs active-btn">🟢Confirmed (our team will contact you within 24hrs)</a>
                           <div class="clearfix"></div>
        </div>
 ...
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Cancelled</a>
            <div class="clearfix"></div>
                ...
                <?php } else { ?>
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">🔴Pending Confirmation(kindly wait for Confirmation)</a>
            <div class="clearfix"></div>
        </div>
                <?php } ?>
