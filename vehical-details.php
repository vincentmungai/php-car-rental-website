    ...
    <div class="listing_detail_head row">
      ...
      <div class="col-md-3">
        <div class="price_info">
          <p style="color: #312e55;">KES <?php echo htmlentities($result->PricePerDay);?> </p>Per Day
        ...
        <div class="main_features">
          <ul>
            ...
            <li> <i class="fa fa-calendar" aria-hidden="true"></i>
              ...
              <p style="color: #312e55;">Reg.Year</p>
            </li>
            <li> <i class="fa fa-cogs" aria-hidden="true"></i>
              <h5><?php echo htmlentities($result->FuelType);?></h5>
              <p style="color: #312e55;">Fuel Type</p>
            </li>
       
            <li> <i class="fa fa-user-plus" aria-hidden="true"></i>
              <h5><?php echo htmlentities($result->SeatingCapacity);?></h5>
              <p style="color: #312e55;">Seats</p>
            </li>
          </ul>
        </div>
        <div class="listing_more_info">
          <div class="listing_detail_wrap"> 
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              <li role="presentation" class="active"><a href="#vehicle-overview " aria-controls="vehicle-overview" role="tab" data-toggle="tab" style="background-color: #312e55;">Vehicle Overview </a></li>
          
              <li role="presentation"><a href="#accessories" aria-controls="accessories" role="tab" data-toggle="tab" style="background-color: #312e55;">Accessories</a></li>
            </ul>
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          ...
          <?php if($_SESSION['login'])
              ...
              <?php } else { ?>
<a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Login to  </a>
        ...
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
              ...
              <p class="list-price">KES<?php echo htmlentities($result->PricePerDay);?></p>
