...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            ...
            <p class="list-price">KES <?php echo htmlentities($result->PricePerDay);?> Per Day 
            <?php if($result->Status==1)
                { ?>
                <div class="vehicle_status"> <a href="#" class="btn outline btn-xs active-btn">🔴Booked</a>
 ...
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Cancelled</a>
            <div class="clearfix"></div>
        </div><div class="vehicle_status"> <a href="#" class="btn outline btn-xs">🟢Available</a>
            <div class="clearfix"></div>
        </div>
                <?php } else { ?>
...
{  ?>
              ...
              <li class="gray-bg">
                ...
                <div class="recent_post_title"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->BrandName);?> , <?php echo htmlentities($result->VehiclesTitle);?></a>
                  <p class="widget_price">KES<?php echo htmlentities($result->PricePerDay);?> Per Day
